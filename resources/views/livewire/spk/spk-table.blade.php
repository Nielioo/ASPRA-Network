<div>
    <div class="col-lg-12 margin-tb">
        <div class="flex items-center justify-between pb-4">
            {{-- @can('spk-create') --}}
            <a class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded" href="{{ route('spks.create') }}">
                Create New SPK</a>
            {{-- @endcan --}}
    ...
    <div class="relative overflow-x-auto shadow-sm sm:rounded-lg">
        <table class="w-full border border-gray-200 text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="px-6 py-4 text-center">No spk has been made.
                        </td>
                    </tr>
                @endforelse
            </tbody>
