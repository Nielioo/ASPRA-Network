<div>
    <div class="col-lg-12 margin-tb">
        <div class="flex items-center justify-between pb-4">
            {{-- @can('schedule-create') --}}
            <a class="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded" href="{{ route('schedules.create') }}">
    ...
    <div class="relative overflow-x-auto shadow-sm sm:rounded-lg">
        <table class="table-auto w-full border border-gray-200 text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center">No schedule has been made.
                        </td>
                    </tr>
                @endforelse
            </tbody>
